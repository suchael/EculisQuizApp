      ...
      <View style={styles.questionInterfaceContainer}>
        <View style={styles.questionScreen}>
          <View style={styles.questionScreenNumberView}>
            ...
            <Text style={styles.questionScreenNumber}>Question {ind}</Text>
            <TouchableOpacity
              style={{
                justifyContent: "center",
                alignItems: "center",
          ...
          >
            <Text style={{ fontSize: 15, fontWeight: "900", color: "blue" }}>
              WAEC: 2005
            </Text>
          </View>
          <Text style={styles.questionScreenQuestionContent}>
            Which of the following statements does not show Rutherford's account
            of Nuclear Theory? An atom contains a region
          </Text>
        </View>
