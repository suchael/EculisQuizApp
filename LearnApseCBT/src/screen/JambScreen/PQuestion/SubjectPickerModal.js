...
const randomQuestions = () => (
  ...
  >
        <Text style={{ fontSize: 18, fontWeight: "bold" , textAlign: "center", backgroundColor: "lightgray", borderWidth: 2, borderColor: "#777", paddingVertical: 2, marginTop: 30, marginHorizontal: 10, borderRadius: 15}}>
			40 Random questions
		</Text>
  </TouchableOpacity>
);
      ...
      <Modal animationType="slide" transparent={true} visible={modalVisible} onRequestClose={closeAndResetModal}>
        ...
        >
          ...
          <View style={{ backgroundColor: 'white', borderRadius: 10, paddingBottom: 10, width: '88%', maxHeight: '80%', borderColor: 'gray', borderWidth: 1 }}>
				...
				<Text style={{ fontSize: 16, fontWeight: "500", textAlign: "center" , borderBottomWidth: 2, borderColor: "#999", paddingBottom: 10 }} numberOfLines={1}>
