  ...
  return (
    ...
    >
      ...
      <TouchableOpacity onPress={openModal}>
        <Ionicons name="ios-calculator-sharp" size={44} color={COLORS.mainBtnText} />
...
function TabBar() {
  ...
  const enableTopTabScroll = () =>
    ...
    examSubject.length > maxTopTabSubject && deviceWidth <= minDeviceWidth
      ? true
      : false;
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={{
        tabBarActiveTintColor: COLORS.mainBtnText,
