...
export default function OnlineBat() {
  return (
    ...
    >
      <Stack.Screen
        name="OnlineBatMain"
        component={OnlineBatMain}
        initialParams={{ showTopicBar: false }}
      />
      <Stack.Screen
        name="OnlineBatGameScreen"
        component={OnlineBatGameScreen}
      />
    </Stack.Navigator>
  );
}
...
function BottomBtn() {
  ...
  return (
    ...
    >
      ...
      {/*Play Button*/}
      <TouchableOpacity
        onPress={() => navigation.navigate("OnlineBatGameScreen")}
        style={{
